...
# =========================
# Assets
# supports old names + png fallback
# =========================
...
def _render_header_old_assets():
    """
    Left image is now the main rectangular banner.
    Right image stays secondary.
    """
    header_left, header_right = st.columns([1.9, 1.1], gap="large")
